...
void ClipLoader::ReadAnimationClips(std::wifstream & fp, UINT numBones, UINT numAnimationClips, std::unordered_map<std::string, AnimationClip>& animations, const std::vector<MeshNode>& meshNodes)
{
}
...
void ClipLoader::AdjustAnimations(AnimationClip & animations, const std::vector<MeshNode>& meshNodes)
{
}

void ClipLoader::SetBoneOffsets(std::vector<DirectX::XMFLOAT4X4>& boneOffsets, const std::vector<MeshNode>& nodes)
{
}
