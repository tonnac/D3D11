...
void ShaderStorage::Initialize(ID3D11Device * Device)
{
	...
	{
		d3dUtil::LoadVertexShaderFile(Device, L"normal.hlsl", nullptr, vertexShader.GetAddressOf(), "VS", vBlob.GetAddressOf());
		d3dUtil::LoadGeometryShaderFile(Device, L"normal.hlsl", nullptr, geometryShader.GetAddressOf(), "GS");
		d3dUtil::LoadPixelShaderFile(Device, L"normal.hlsl", nullptr, pixelShader.GetAddressOf());
