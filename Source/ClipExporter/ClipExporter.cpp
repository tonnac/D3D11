...
bool ClipExporter::Initialize(Interface* maxinterface, const MCHAR* Filename, const MCHAR* Longdesc)
{
...
bool ClipExporter::Run()
{
	...
	mWriter = std::make_unique<ClipWriter>(mVersion, mFilename, mSceneInfo, 
...
void ClipExporter::AddMaterial(INode * node)
{
	Mtl* mtl = node->GetMtl();
	if (mtl == nullptr)
	{
...
void ClipExporter::LoadMaterial()
{
...
void ClipExporter::LoadTexture(ZXCSMaterial & ZXCSMtl, Mtl * srcMtl)
{
