...
void ClipWriter::WriteScene(std::wofstream & os)
{
...
void ClipWriter::WriteMaterial(std::wofstream & os)
{
...
void ClipWriter::WriteMesh(std::wofstream & os)
{
...
void ClipWriter::WriteHelper(std::wofstream & os)
{
...
void ClipWriter::WriteSubset(std::wofstream & os)
{
	UINT i = 0;
...
void ClipWriter::WriteVertexW(std::wofstream & os)
{
...
void ClipWriter::BuildSubset(UINT & meshes, UINT & helpers, UINT & subsets, UINT & vertices, UINT & indices)
{
	for (auto& x : mObjects)
	{
		if (x->Type == ObjectType::MESH)
...
std::wstring ClipWriter::Savetime()
{
