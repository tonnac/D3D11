...
VertexOut VS(VertexIn vIn)
{
	...
	vOut.TangentW = mul(vIn.TangentL, (float3x3)gWoridInv);
...
//	bumpedNormalW = vOut.n;
	...
	float3 litColor = ComputeLighting(gLights, mat, vOut.PosW, vOut.n, bumpedNormalW, shadowFactor, gDirctionNum, gPointNum, gSpotNum);
