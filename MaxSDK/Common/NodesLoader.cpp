...
void NodesLoader::LoadMesh(INode* node, ZXCObject* o)
{
	...
	{
		LoadVertex(mesh, tm, o, i, i0, i1, i2);
		LoadTexCoord(mesh, tm, o, i, i0, i1, i2);
		LoadColor(mesh, tm, o, i, i0, i1, i2);
		LoadNormal(mesh, tm, o, i, i0, i1, i2);
...
void NodesLoader::LoadVertex(const Mesh & mesh, const Matrix3 & tm, ZXCObject * o, int i, std::uint32_t i0, std::uint32_t i1, std::uint32_t i2)
{
	Point3 v;
...
void NodesLoader::LoadTexCoord(const Mesh & mesh, const Matrix3 & tm, ZXCObject * o, int i, std::uint32_t i0, std::uint32_t i1, std::uint32_t i2)
{
...
void NodesLoader::LoadColor(const Mesh & mesh, const Matrix3 & tm, ZXCObject * o, int i, std::uint32_t i0, std::uint32_t i1, std::uint32_t i2)
{
...
void NodesLoader::LoadNormal(Mesh & mesh, const Matrix3 & tm, ZXCObject * o, int i, std::uint32_t i0, std::uint32_t i1, std::uint32_t i2)
{
	mesh.buildNormals();
...
void NodesLoader::BuildVBIB(ZXCObject* mesh)
{
	static int Cnt = 0;
	...
	auto & vertices = mExporter->mVertices;
	auto & Indices = mExporter->mIndices;
