...
public:
    ...
    /*! Allocates a new mesh flattener and performs the flattening process.
        ...
        being dangling if the flattener were kept around while other components were to evaluate the node.
    ...
    */
    virtual void GetSubMesh(
        ...
        std::vector<TextureCoordChannel>& textureCoordChannels) const = 0;
};
