...
public:
	...
	*/
    ...
    ID is passed.
    \param ColorId id.  Specifies which color to set.
    \param COLORREF color. The color value to set. See <a href="https://msdn.microsoft.com/en-us/library/dd183449(v=vs.85).aspx">COLORREF</a>.
	\param State state.  Specifies which color state for the color
    ...
    \param ColorId id. Specifies which color to get.
	\param State state. Specifies which color state for the color
    ...
    \param ColorId id. The color whose brush handle is returned. 
	\param State state. Specifies which color state for the color
    ...
    */
	...
	value.
	\param ColorId id. Specifies which default color to get.
	\param State state. Specifies which color state for the default color
	\return  The color is returned or black (RGB(0,0,0)) if the ColorId passed
	was not found. */
