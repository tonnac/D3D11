...
//
// Example for Kirin = 19:
//			First Release Service Pack would be:	19.1.<build>.0
//			Second Release Service Pack would be:	19.2.<build>.0
//			Etc.
//
...
#define MAX_PRODUCT_VERSION_MAJOR 19
#endif
...
#define MAX_PRODUCT_YEAR_NUMBER 2017
#endif
