...
public:
	...
	*/
	...
	/*! \remarks This method is for internal use only. */
	CoreExport void HorizTextButtons(BOOL b) { horizTextBtns = b; }
	/*! \remarks This method is for internal use only. */
    CoreExport int GetHorizTextButtons() { return horizTextBtns; }
	/*! \remarks This method is for internal use only. */
    CoreExport void FixedWidthTextButtons(BOOL b) { fixedWidthTextBtns = b; }
	/*! \remarks This method is for internal use only. */
    CoreExport int GetFixedWidthTextButtons() { return fixedWidthTextBtns; }
	/*! \remarks This method is for internal use only. */
    CoreExport void SetTextButtonWidth(int w) { btnWidth = w; }
	/*! \remarks This method is for internal use only. */
    CoreExport int GetTextButtonWidth() { return btnWidth; }
