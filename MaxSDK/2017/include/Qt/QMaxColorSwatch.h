 ...
 * 
 * \todo Still missing copy/paste context menus as well as the swap/copy 
 *       decision on drag'n'drop.
 *       Interactive signal does not get emitted yet
 */
...
protected:
	...
	//virtual void stopInteractive( bool canceled );
