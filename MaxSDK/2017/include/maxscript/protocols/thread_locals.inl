...
// create any Values before resetting alloc_frame
	...
	def_thread_local( NewCollectableLinkedListItem*,				last_new_collectable,		FALSE,	NULL);			// linked list of Collectables created via new before initialized as a Value
