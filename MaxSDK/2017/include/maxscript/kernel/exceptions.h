...
// classes that derived from MAXScriptRuntimeErrorException automatically
// capture the mxs callstack. Compile errors,  FunctionReturn, etc. don't need to 
// capture the mxs callstack.
