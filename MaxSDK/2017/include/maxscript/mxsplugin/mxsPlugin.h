...
public:
	...
	int				Display(TimeValue t, INode* inode, ViewExp *vpt, int vflags, ModContext* mc) { return delegate->Display( t, inode, vpt, vflags, mc); };   // quick render in viewport, using current TM.         
